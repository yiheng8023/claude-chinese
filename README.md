...
专为 Anthropic **Claude Desktop** 桌面客户端（Windows MSIX / Win32 / macOS / Linux）打造的高性能、可逆式中文本地化工具包（当前版本 **v1.2.64**）。基于官方原生 i18n 架构打造增量挂载与自愈工程体系，实现全量 UI 界面汉化与版本更新自动自愈。
...
- 🎯 **全量 HashKey 界面与长篇折叠文档覆盖**：覆盖全量 20,800+ 核心词条与 113 篇全景折叠长文档（包含 Cowork 协同画布、权限审批流、Claude Code 模式、思考强度下拉与名著阅读对比）。
...
│   ├── test-icu.js                   # 全量 20,800+ 词条 ICU 占位符与专有名词保护断言
